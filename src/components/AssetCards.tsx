...
const AssetCard:FC<AssetCardProp>= (props) => {
    return (
        <div className="h-[21.875rem] w-[18.25rem] bg-cardBg bg-cover bg-no-repeat mr-16">
            {/* showing token icon */}
            ...
            <div className="h-auto relative -top-5 w-[18.25rem]">
                {/* rendering token information */}
                <Text text={props.assetName} innerClass="text-[#737BAE] text-xs text-center"/>
                <ValueWrapper currentPrice={props.price} variation={props.priceVariation} additionalClasses="mt-4"/>
                ...
                <PopularPairs tokens={props.pairList}/>
